...
def main() -> None:
    ...
    (
        id_tokenizer.unk_token,
        id_tokenizer.cls_token,
        id_tokenizer.sep_token,
        id_tokenizer.pad_token,
        id_tokenizer.mask_token,
    ) = ["[UNK]", "[CLS]", "[SEP]", "[PAD]", "[MASK]"]
    ...
    def compute_metrics(eval_preds):
        ...
        prediction_lens = [
            np.count_nonzero(pred != id_tokenizer.pad_token_id) for pred in pred_ids
        ]
